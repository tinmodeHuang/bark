...
bool bark::world::evaluation::EgoBeyondPointLabelFunction::Evaluate(const world::ObservedWorld& observed_world, const AgentId& agent_id) const  {
  ...
  if (lc) {
    ...
    return ((ego_frenet.lon - point_frenet.lon) > 0);
  }
  return false;
}
